...
denoServe(
  handleCORS(async (req: Request) => {
    ...
    console.log("Dig play slots called with group:", group)
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/dig-play-slots' \
...
/* To invoke from another Supabase Function:
    ...
    const response = await supabase.functions.invoke('dig-play-slots')
